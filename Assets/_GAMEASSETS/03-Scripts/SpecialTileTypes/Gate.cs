...
namespace LittleSubmarine2
{
    public class Gate : MonoBehaviour, IActivatable
    {
        ...
        {
            Message<ActivateButtonEvent>.Add(OnActivateButtonEvent);
        }

        private void OnDisable()
        {
            Message<ActivateButtonEvent>.Remove(OnActivateButtonEvent);
        }
        ...
        private void OnActivateButtonEvent(ActivateButtonEvent ctx)
        {
